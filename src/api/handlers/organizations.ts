        ...
        Effect.gen(function* () {
            ...
            return handlers
                .handle("create", ({ payload }) =>
                    Effect.gen(function* () {
                        // Note: Creating an org might be allowed without an API key in a real system (signup),
                        // but per specs auth is required. Either user uses a master key or seed script creates first org.
